# -*- coding: utf-8 -*-
"""Real_Estate_price_pridiction_using_python.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12koh-TedavCneBj_e3fpnKTqHDvT7i6I
"""
...
real_estate_data.dropna()
real_estate_data.max()

real_estate_data.min()

real_estate_data.sample()
...
# Identify datetime columns and convert them to numeric features
for col in real_estate_data.columns:
    if pd.api.types.is_datetime64_any_dtype(real_estate_data[col]):
        real_estate_data[f'{col}_year'] = real_estate_data[col].dt.year
        real_estate_data[f'{col}_month'] = real_estate_data[col].dt.month
        real_estate_data[f'{col}_day'] = real_estate_data[col].dt.day
        real_estate_data[f'{col}_hour'] = real_estate_data[col].dt.hour
        # Drop the original datetime column
        real_estate_data.drop(col, axis=1, inplace=True)
